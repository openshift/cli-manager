...
func (in *FileOperation) DeepCopyInto(out *FileOperation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FileOperation.
func (in *FileOperation) DeepCopy() *FileOperation {
	if in == nil {
		return nil
	}
	out := new(FileOperation)
	in.DeepCopyInto(out)
	return out
}
