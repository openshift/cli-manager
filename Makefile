...
SOURCE_GIT_TAG ?=$(shell git describe --long --tags --abbrev=7 --match 'v[0-9]*' || echo 'v0.1.1-$(SOURCE_GIT_COMMIT)')
...
$(call build-image,cli-manager,$(IMAGE_REGISTRY)/ocp/4.18:cli-manager, ./Dockerfile,.)
